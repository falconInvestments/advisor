...
// get the topics model - our table name will be topics as set in the following line
db.Topics = require('./topicModel')(sequelize, DataTypes)
db.Tips = require('./tipModel')(sequelize, DataTypes)
...
db.Tips.belongsTo(db.Topics);
db.Topics.hasMany(db.Tips);
